...
public class FileBackedTasksManagerTest extends TaskManagerTest <FileBackedTasksManager> {
    ...
    public void CheckForEpicsWithoutSubs() {
        FileBackedTasksManager fbBefore = new FileBackedTasksManager("testfiles/epicTest.csv");
        fbBefore.addEpic(new Epic("Epic1", "epic1Desc"));
        fbBefore.addEpic(new Epic("Epic2", "epic2Desc"));
        FileBackedTasksManager fbAfter = FileBackedTasksManager.loadFromFile(new File("testfiles/epicTest.csv"));
        assertEquals(fbAfter.getAllEpics().size(), fbBefore.getAllEpics().size());
    }

    @Test
    public void CheckForEmptyFBTaskManager() {
        FileBackedTasksManager fbBefore1 = new FileBackedTasksManager("testfiles/emptyTest.csv");
        fbBefore1.save();
        FileBackedTasksManager fbAfter1 = FileBackedTasksManager.loadFromFile(new File("testfiles/emptyTest.csv"));
    ...
    public void CheckForEmptyHistory() {
        FileBackedTasksManager fbBefore2 = new FileBackedTasksManager("testfiles/emptyHistoryTest.csv");
        ...
        FileBackedTasksManager fbAfter2 = FileBackedTasksManager.loadFromFile(new File("testfiles/emptyHistoryTest.csv"));
